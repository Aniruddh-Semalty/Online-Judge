    ...
    <div className="flex justify-between bg-[#202020] p-4 items-center w-full ">
      ...
      <div className="flex items-center  justify-between">
        ...
        <div className="w-[120px]">
          {user ? (
            <div className="w-6 mx-4" onClick={toggleDropdown}>
              <img
              ...
              {isDropdownOpen && ( // Render dropdown content if dropdown is open
                <div className="absolute mt-4 bg-[#202020] text-white rounded-md py-2 w-auto ">
            ...
            <div>
              ...
              <Link
                to="/login"
                className="no-underline mx-4 text-[#F0F0F0] font-bold text-lg"
              >
               Login
              </Link>
            </div>
